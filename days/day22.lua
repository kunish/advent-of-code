...
function day22_contained(volume1, volume2)
  return volume2.x1 >= volume1.x1
    and volume2.x1 <= volume1.x2
    and volume2.x2 >= volume1.x1
    and volume2.x2 <= volume1.x2
    and volume2.y1 >= volume1.y1
    and volume2.y1 <= volume1.y2
    and volume2.y2 >= volume1.y1
    and volume2.y2 <= volume1.y2
    and volume2.z1 >= volume1.z1
    and volume2.z1 <= volume1.z2
    and volume2.z2 >= volume1.z1
    and volume2.z2 <= volume1.z2
end

function day22_overlap(volume1, volume2)
  return (
    (
      (volume2.x1 >= volume1.x1 and volume2.x1 <= volume1.x2)
      or (volume2.x2 >= volume1.x1 and volume2.x2 <= volume1.x2)
      or (volume1.x1 >= volume2.x1 and volume1.x1 <= volume2.x2)
      or (volume1.x2 >= volume2.x1 and volume1.x2 <= volume2.x2)
    )
    and ((volume2.y1 >= volume1.y1 and volume2.y1 <= volume1.y2) or (volume2.y2 >= volume1.y1 and volume2.y2 <= volume1.y2) or (volume1.y1 >= volume2.y1 and volume1.y1 <= volume2.y2) or (volume1.y2 >= volume2.y1 and volume1.y2 <= volume2.y2))
    and (
      (volume2.z1 >= volume1.z1 and volume2.z1 <= volume1.z2)
      or (volume2.z2 >= volume1.z1 and volume2.z2 <= volume1.z2)
      or (volume1.z1 >= volume2.z1 and volume1.z1 <= volume2.z2)
      or (volume1.z2 >= volume2.z1 and volume1.z2 <= volume2.z2)
    )
  )
end
...
function day22(path)
  ...
  for i = 1, #steps do
    ...
    local vol =
      day22_volume_init(steps[i][2], steps[i][3], steps[i][4], steps[i][5], steps[i][6], steps[i][7], steps[i][1])
